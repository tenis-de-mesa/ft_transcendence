  ...
  return (
    <div>
      <div 
        ...
        className={classNames("md:hidden fixed inset-0 max-h-screen z-[998] bg-gray-900/50", {
          "block": isOpen,
          "hidden": !isOpen
        })}
      >
      ...
      >
        <div className={classNames("flex flex-row w-full py-3 mx-2 mb-8 transform ease-out duration-100", {
          "px-5": isOpen
        })}>
          <img src={darkMode ? images.logoLight : images.logoDark} width={45} className="select-none" />
        ...
        <div className={classNames("h-1/12 link", {
          "h-screen": isMob
        })}>
          <img src={images.demoAvatar} className="w-10 h-10 rounded-full cursor-pointer select-none"/>
          {isOpen ? (
