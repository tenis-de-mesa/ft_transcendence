	...
	return (
		<>
			<div className="grid h-screen place-content-center text-center bg-gray-300 dark:bg-gray-700">
				<Typography customWeight="regular" variant="h1">{status}</Typography>
				<Typography customWeight="regular" variant="h4">{statusText}</Typography>
				<br></br>
				<Link to={"/"} className="flex justify-center">
					<Button size="md" variant="info">Home</Button>
				</Link>
			</div>
		</>
	)
